...
* Nusi server la le nyuie be yeasrɔ̃e nye wò IP adrɛs kple ɣeyiɣi si me nàwɔ wò dɔwɔna — shielded transactions kpɔa nusi yia blockchain dzi ta, ke menye wò kadodo kple server la o.
