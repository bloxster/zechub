...
Nanso nhomakorabea sohwɛfo no da so ara hu ɔkenkanfo ko a ɔkɔɔ mu, bere bɛn, ne sɛnea wɔde bundle a ɛyɛ den kɔe. Ɛno ne IP address ne bere — a wotumi hu fi pon no so, ɛmfa ho sɛnea wɔatoto envelope no mu yiye. Tor yɛ nea ɛne sɛ wobɛsoma ɔdemafo a wɔmmɔ ne din sɛ: nhomakorabea sohwɛfo no da so ara de nhoma koro no ara ma, nanso onnim onii fie bio.
